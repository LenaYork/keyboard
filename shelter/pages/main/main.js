...
document.querySelectorAll(".desktop-arrow").forEach(elem => elem.addEventListener("click", function() {

    document.querySelectorAll(".friend-item").forEach(elem => {
        document.querySelector(".friends-items").removeChild(elem);
    });
...
document.querySelectorAll(".hidden-arrow").forEach(elem => elem.addEventListener("click", function() {
